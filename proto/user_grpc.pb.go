...
type UserServiceClient interface {
	ValidateUser(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error)
}
...
func (c *userServiceClient) ValidateUser(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
...
type UserServiceServer interface {
	ValidateUser(context.Context, *UserRequest) (*UserResponse, error)
...
func (UnimplementedUserServiceServer) ValidateUser(context.Context, *UserRequest) (*UserResponse, error) {
...
func _UserService_ValidateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).ValidateUser(ctx, req.(*UserRequest))
	}
