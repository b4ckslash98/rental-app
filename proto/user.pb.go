...
const file_proto_user_proto_rawDesc = "" +
	...
	"\bis_valid\x18\x01 \x01(\bR\aisValid2D\n" +
	"\vUserService\x125\n" +
	"\fValidateUser\x12\x11.user.UserRequest\x1a\x12.user.UserResponseB\n" +
...
var file_proto_user_proto_depIdxs = []int32{
	0, // 0: user.UserService.ValidateUser:input_type -> user.UserRequest
	1, // 1: user.UserService.ValidateUser:output_type -> user.UserResponse
